...
import edu.ucacue.xrlab.infraestructura.services.login.UsuarioService;
import edu.ucacue.xrlab.modelo.Login.Mensaje;
...
public class UsuarioRestController {
	...
	public ResponseEntity<?> actualizarUsuario(@PathVariable("id") int id, @RequestBody Usuario usuario){
       // Usuario updateUser = userRepository.findById(id);
              //  .orElseThrow(() -> new ResourceNotFoundException("User not exist with id: " + id));

        
     //   updateUser.setEstado(userDetails.getEstado());
    ...
    //    return ResponseEntity.ok(updateUser);
		...
		Usuario usuarios = usuarioServices.getUsuario(id).get();
